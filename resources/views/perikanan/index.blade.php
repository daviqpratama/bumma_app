...
<div style="display: flex; height: 100vh; box-sizing: border-box;">
    ...
    <main style="flex: 1; overflow-y: auto; padding: 16px; box-sizing: border-box; height: 100%;">
        <!-- Judul dan Subjudul -->
        <div class="mb-8">
            <h1 style="font-size: 48px; font-weight: bold; line-height: 1; margin-bottom: 12px;">PERIKANAN
            <p style="font-size: 20px; color: #4B5563; margin-bottom: 40px;">BUDIDAYA IKAN MUJAIR DAN IKAN LELE
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
                <div style="width: 524px; height: 294px; overflow: hidden;">
                    <img src="{{ asset('images/ikan tuna.jpg') }}" alt="Ikan Tuna" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
            ...
            <div>
                ...
                Usaha budidaya perikanan air tawar yang mengelola ikan tuna. Perikanan ini berperan penting dalam menjaga ketahanan pangan masyarakat adat sekaligus meningkatkan pendapatan komunitas dengan metode budidaya yang berkelanjutan.
                </p>
