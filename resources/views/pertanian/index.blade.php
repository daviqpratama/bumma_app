...
<div style="display: flex; height: 100vh; box-sizing: border-box;">
    ...
    <main style="flex: 1; overflow-y: auto; padding: 16px; box-sizing: border-box; height: 100%;">
        <!-- Judul dan Subjudul -->
        <div class="mb-8">
            <h1 style="font-size: 48px; font-weight: bold; line-height: 1; margin-bottom: 12px;">PERTANIAN</h1>
            <p style="font-size: 20px; color: #4B5563; margin-bottom: 40px;">VANILLI DAN KOPI</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
                <div style="width: 524px; height: 294px; overflow: hidden;">
                    <img src="{{ asset('images/tanaman.jpg') }}" alt="Tanaman" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
            ...
            <div>
                ...
                Usaha pertanian yang mengembangkan komoditas unggulan seperti vanili dan kopi dengan metode bertani berkelanjutan berbasis kearifan lokal. Pertanian ini mendukung ketahanan pangan dan ekonomi masyarakat adat.
                </p>
