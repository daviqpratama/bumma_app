...
<div style="display: flex; height: 100vh; box-sizing: border-box;">
    ...
    <main style="flex: 1; overflow-y: auto; padding: 16px; box-sizing: border-box; height: 100%;">
        <!-- Judul dan Subjudul -->
        <div class="mb-8">
            <h1 style="font-size: 48px; font-weight: bold; line-height: 1; margin-bottom: 12px;">PETERNAKAN
            <p style="font-size: 20px; color: #4B5563; margin-bottom: 40px;">SAPI
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
                <div style="width: 524px; height: 294px; overflow: hidden;">
                    <img src="{{ asset('images/sapi.jpg') }}" alt="Sapi" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
            ...
            <div>
                ...
                Unit peternakan masyarakat adat yang membudidayakan sapi. Peternakan ini mendukung kebutuhan pangan lokal serta menjadi sumber pendapatan penting bagi komunitas adat melalui metode pemeliharaan tradisional yang ramah lingkungan.
                </p>
