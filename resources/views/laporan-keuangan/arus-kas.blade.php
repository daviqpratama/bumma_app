...
<div class="container mt-4 p-4 bg-white rounded shadow-sm border" style="font-size: 13px;">
    ...
    <table class="table table-bordered">
        ...
        <tr class="table-light fw-bold"><td>KAS BERSIH DARI AKTIVITAS USAHA ADAT</td><td class="text-end">Rp -</td></tr>
        ...
        <tr class="table-light fw-bold"><td>KAS BERSIH DARI AKTIVITAS SOSIAL DAN RITUAL ADAT</td><td class="text-end">Rp -</td></tr>
        ...
        <tr class="table-light fw-bold"><td>KAS BERSIH DARI AKTIVITAS PENDANAAN</td><td class="text-end">Rp -</td></tr>
        ...
        <tr class="table-light fw-bold"><td>SALDO KAS AKHIR PERIODE</td><td class="text-end">Rp -</td></tr>
    </table>
</div>
@endsection
